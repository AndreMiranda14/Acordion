# Frontend Mentor - FAQ sanfona cartão

![Visualização do design para o desafio de codificação de cartão sanfonado de perguntas frequentes](./design/desktop-preview.jpg)
...
Seu desafio é construir este cartão sanfonado de perguntas frequentes e deixá-lo o mais próximo possível do design.
